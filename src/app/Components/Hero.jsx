      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-col justify-center w-full lg:w-1/2 space-y-4 text-left text-white">
            <motion.h1 className="text-3xl md:text-4xl min-h-27 lg:max-w-2xl font-extrabold" initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2, duration: 0.8 }}>
            ...
            <motion.p className="max-w-xl text-sm md:text-base text-gray-300" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6, duration: 0.8 }}>
              I am from Bangladesh, passionate about building simple, fast, and clean web applications using the MERN stack.
            </motion.p>

            <motion.div className="font-semibold text-base" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7, duration: 0.8 }}>
              Find Me
            </motion.div>

            <motion.div className="flex space-x-6 text-xl" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.8, duration: 0.8 }}>
